...
<div class="container">
			<div class="row">
				<div class="col-sm-12">
					<form:form class="form-horizontal" modelAttribute="product" action="/product" method="POST">
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<form:select  path="category" id="category" class="form-control">
									<c:forEach items="${categorys}" var="rentType">
						...
						<div class="form-group">
							<label for="subCategory" class="control-label col-sm-2">Sub Category:</label>
							<div class="col-sm-10">
								<form:select  path="subCategory" id="subCategory" class="form-control">
						...
						<div class="form-group">
							<label for="subSubCategory" class="control-label col-sm-2">Street:</label>
							<div class="col-sm-10">
								<form:select  path="subSubCategory" id="subSubCategory" class="form-control">
									<c:forEach items="${subSubCategorys}" var="subSubCategory">
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<form:input path="description" id="description" class="form-control" rows="5"/>
							</div>
						</div>
						<div class="form-group">
